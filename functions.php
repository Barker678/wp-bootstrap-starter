...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style('wp-glide-core-css', get_template_directory_uri() . '/node_modules/@glidejs/glide/dist/css/glide.core.min.css');
    wp_enqueue_style('wp-glide-theme-css', get_template_directory_uri() . '/node_modules/@glidejs/glide/dist/css/glide.theme.min.css');
	// load bootstrap css
	// load AItheme styles
    ...
    wp_enqueue_script('wp-glide-js', get_template_directory_uri() . '/node_modules/@glidejs/glide/dist/glide.min.js', array(), '' ,true );
